...
INSERT INTO `tbl_grupo_usuario`(`id`,`nome`)VALUES(UUID(),'ADMIN'),(UUID(),'USUARIO');
...
(UUID(),'email@gmail.com',null,1,'ADMONISTRADOR','Administrador','$2a$10$j6iKY9lDkA/lWrSvLWCOZOCFoAWg4tU4H3TNXJq98Cov/HO1axXFi','admin','01234567890');
