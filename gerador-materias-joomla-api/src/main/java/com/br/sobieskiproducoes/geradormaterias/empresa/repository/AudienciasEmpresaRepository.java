 ...
 */
public interface AudienciasEmpresaRepository extends JpaRepository<AudienciaEmpresaEntity, String> {
    @Query("""
            SELECT  \
                t  \
            FROM \
            ...
            WHERE \
                ...
                """)
    List<AudienciaEmpresaEntity> consulta(@Param("nome") String nome, @Param("idEmpresa") String idEmpresa, @Param("idUsuario") String idusuario,
            Pageable paginacao);
    ...
    @Query("""
            ...
            WHERE \
                    ...
                    u.id = :idUsuario \
                """)
    Optional<AudienciaEmpresaEntity> get(@Param("idAudiencia") String idAudiencia, @Param("idEmpresa") String idEmpresa, @Param("idUsuario") String idUsuario);
}
