...
public class CategoriaJoomlaClient {

  private static final String URL_BASE = "/content/categories";

  private static final String URL_BASE_CONCAT_URL = "/content/categories?";
  private static final String URL_BASE_CONCAT_PARAM = "/content/categories?page[limit]=";

  private static final String PARAM_PAGEE = "&page[offset]";

  private final RestTemplate restTemplate;

  public GenericoItemJoomlaResponse<List<GenericoJoomlaDataDTO<AtributosCategoriaJoomlaDTO>>> getCategorias(final JoomlaConfigurationEntity configuracao) {
