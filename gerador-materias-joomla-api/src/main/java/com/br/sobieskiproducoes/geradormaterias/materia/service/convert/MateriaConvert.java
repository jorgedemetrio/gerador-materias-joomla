...
import com.br.sobieskiproducoes.geradormaterias.materia.controller.dto.FaqDTO;
...
import com.br.sobieskiproducoes.geradormaterias.materia.model.FAQEntity;
...
public interface MateriaConvert {
    ...
    LogDialogoChatGPTEntity convert(final RepostaResponseDTO dto, ChoicesDTO choice, LocalDateTime inicio, String pergunta, String uuid);
    ...
    AtributosArtigoJoomlaSalvarJoomlaDTO convertJoomla(MateriaEntity materia);
